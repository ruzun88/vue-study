...
module.exports = {
  ...
  entry: './index.js',
  output: {
    filename: 'bundle.js', // 임의의 파일명을 설정해도 되지만, 특수 block을 통해 자동적으로 이름을 지정할 수도 있다. [chunkhash] 등
    ...
    rules: [ // loader 규칙
      {
        ...
        use: [
          { loader: MiniCssExtractPlugin.loader }, // 본 plugin을 통한 로더 사용 시, css 파일이 별도로 빠지게 됨
          'css-loader'
        ]
      }
    ]
  },
  plugins: [ // 결과물의 형태를 바꾸거나, 추가적인 기능을 제공함
